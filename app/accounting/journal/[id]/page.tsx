  ...
  return (
    <AppLayout>
      <div className="space-y-5 max-w-3xl">
        ...
        <div className="flex items-center justify-between">
          ...
          {entry.status === 'POSTED' && (
            <button
              ...
              disabled={reversing}
              className="flex items-center gap-2 px-4 py-2 border-2 border-red-300 text-red-700 hover:bg-red-50 font-semibold rounded-lg transition-all disabled:opacity-50"
            >
        ...
        {message && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-3 text-red-700 text-sm">{message}</div>
        )}

        {/* Entry details */}
        <div className="bg-white border-2 border-gray-200 rounded-xl p-5 shadow-sm space-y-3">
