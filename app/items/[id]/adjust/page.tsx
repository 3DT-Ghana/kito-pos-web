...
export default function AdjustQuantityPage() {
  ...
  // Stock belongs to one branch, so the server rejects an adjustment made
  // while "All Branches" is selected. Without this the cashier filled in the
  // whole form and only learned that on submit.
      ...
      <AppLayout>
        <div className="max-w-xl mx-auto space-y-5">
          ...
          <OperationalBranchPrompt
            ...
            description="Each branch holds its own stock, so an adjustment has to name the branch it applies to. Pick the branch you are counting to continue."
          />
        </div>
      </AppLayout>
    )
